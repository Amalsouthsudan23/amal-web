  ...
  return(
    <div className="shadow-sm lg:mb-0 mb-8">
      <div className="relative">
        ...
        <Link 
          className="bg-white z-30 bg-opacity-75 hover:bg-opacity-100 rounded flex items-center justify-end absolute right-4 bottom-2 px-2 py-2"
          to={`/camps/map?lat='85'&lan='52'`}
        >
